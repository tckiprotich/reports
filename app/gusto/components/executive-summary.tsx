...
const GustoExecutiveSummary = ({ data }: ExecutiveSummaryProps) => {
  return (
    <section className="py-12 px-6 md:px-10 lg:px-16">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-3xl font-bold mb-6 text-purple-900">Executive Summary</h2>
        <Card className="border-purple-200 shadow-lg">
          <CardContent className="pt-6">
            <p className="text-lg mb-4">
              Gusto's visibility across AI platforms varies significantly, indicating major opportunities for
            ...
            <div className="mt-8 p-4 bg-purple-100 border-l-4 border-purple-500 rounded">
              <p className="font-medium text-purple-800">
                Millions of potential customers are using AI platforms to discover HR and payroll solutions like Gusto, 
                but your visibility on emerging platforms is preventing maximum discovery.
              </p>
            </div>
          </CardContent>
        </Card>
...
export default GustoExecutiveSummary
