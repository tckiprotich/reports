...
const NalaExecutiveSummary = ({ data }: ExecutiveSummaryProps) => {
  return (
        ...
        <Card className="border-blue-200 shadow-lg">
          <CardContent className="pt-6">
            <p className="text-lg mb-4">
              NALA's visibility across AI platforms varies significantly, indicating opportunities for
            ...
            <div className="mt-8 p-4 bg-blue-100 border-l-4 border-blue-500 rounded">
              <p className="font-medium text-blue-800">
                Millions of potential customers across the African diaspora are using AI platforms to discover remittance
                and payment solutions like NALA, but visibility barriers on certain platforms are preventing maximum discovery.
              </p>
            </div>
          </CardContent>
        </Card>
...
export default NalaExecutiveSummary
